...
//    public TextField tfRoleWeaponId;
//    public TextField tfRoleHolyRelicId;
...
//    }
//    @FXML
//    private void onUpdateRoleClicked() throws SQLException {
//        int id = Integer.parseInt(tfRoleId.getText());
//        RoleDao.updateRole(new Role(
//                Integer.parseInt(tfRoleId.getText()),
//                tfRoleName.getText(),
//                taRoleIntroduce.getText(),
//                Integer.parseInt(tfRoleBaseHp.getText()),
//                Integer.parseInt(tfRoleHolyRelicId.getText()),
//                Integer.parseInt(tfRoleWeaponId.getText())));
//        roleResult.setText("修改"+id+"号角色");
//    }
//    @FXML
//    private void onUpdateHolyRelicClicked() throws SQLException {
//        int type = getHolyRelicType();
//        if (type==-1){
//            holyRelicResult.setText("请选择圣遗物类型");
//            return;
//        }
//        int id = HolyRelicDao.updateHolyRelic(new HolyRelic(Integer.parseInt(tfHolyRelicId.getText()),tfHolyRelicName.getText(),type,Integer.parseInt(tfHolyRelicProvideHp.getText())));
//        holyRelicResult.setText("修改"+id+"号圣遗物");
//    }
//    @FXML
//    private void onUpdateWeaponClicked() throws SQLException {
//        int type = getWeaponType();
//        if (type==-1){
//            weaponResult.setText("请选择武器类型");
//            return;
//        }
//        int id = WeaponDao.updateWeapon(new Weapon(Integer.parseInt(tfWeaponId.getText()),tfWeaponName.getText(),type,Integer.parseInt(tfWeaponProvideHp.getText())));
//        weaponResult.setText("修改"+id+"号角色");
//    }
