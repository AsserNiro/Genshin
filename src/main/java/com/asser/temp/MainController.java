...
//        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("InsertPage.fxml"));//跳转对应界面
...
//        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("DeletePage.fxml"));//跳转对应界面
//        Scene scene = new Scene(fxmlLoader.load());
...
//        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("UpdatePage.fxml"));//跳转对应界面
//        Scene scene = new Scene(fxmlLoader.load());
...
//        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("QueryPage.fxml"));//跳转对应界面
//        Scene scene = new Scene(fxmlLoader.load());
